...
import { WorkflowsTable } from './components/ui'
 ...
 */
function App() {
  const [currentProduct, setCurrentProduct] = useState('mirror')
  const [activeNavItem, setActiveNavItem] = useState('workflows')
    ...
    >
      <div style={{ display: 'flex', flex: 1, minHeight: 0 }}>
        ...
        <div style={{ 
          ...
          {/* Empty state for other pages (not shown when workflows table is visible) */}
          {!(currentProduct === 'mirror' && activeNavItem === 'workflows' && workflowsTab === 'production') && (
            <div style={{ 
              flex: 1, 
              display: 'flex', 
              flexDirection: 'column', 
